...
$(document).ready(function () {
     ...
     */
    fetch('https://raw.githubusercontent.com/laudebugs/cifc/release/clubs.json', {
        method: 'GET',
        mode: 'cors',
        cache: 'no-cache',
        ...
        .then((clubs) => {
          ...
          ${tag}
                ...
                <h2 class="clubName">${club['Name']}</h2>
                    ...
                    <div class="placeImageHere clubCoverImage" 
                      style="background-image: url(https://raw.githubusercontent.com/laudebugs/cifc/release/covers/${
                          club['cover']
                      }); height: 175px">
                    </div>
                    <span class="clubMetaData">
                        ...
                        <p class="meetingPlace"><b class="meetingTitle">Time:</b> ${
                            club['Weekly Meeting Time'] ? club['Weekly Meeting Time'] : 'N/A'
                        }</p>
          ...
          `
            ...
            $('.button').click(function (e) {
                 ...
                 */
                let buttons = [...$('.button')].filter((tag) => !tag.classList.contains('selected'))
                /**
